...
Focus on evidence published 2018–2026. Exclude review articles unless they are systematic meta-analyses.`}
          ...
          <div className="p-4 bg-bg-surface border border-border-subtle rounded-xl space-y-3">
            ...
            <ul className="space-y-2 text-xs text-text-muted leading-relaxed">
              <li className="flex gap-2"><span className="text-brand-core flex-shrink-0">•</span><span><span className="text-text-body font-medium">Overall confidence</span> is generated by Claude Opus after reading all 40 retrieved corpus chunks. It reflects how consistently and strongly the preclinical literature (animal models, in vitro studies) supports a mechanistic link between this drug's pharmacology and the predicted patient phenotype. It is not derived from a formula — it is Opus's synthesis judgment, informed by Bayesian Beta-Binomial priors computed from animal-model keyword counts across the retrieved chunks.</span></li>
